    ...
    .user-metric.standard { border-top-color: #64748b; }
    .user-metric-label { margin: 0; color: var(--muted); font-size: .68rem; font-weight: 800; letter-spacing: .09em; text-transform: uppercase; }
    .user-metric-value { display: block; margin-top: 9px; color: var(--navy-900); font-size: 1.9rem; line-height: 1; }
    ...
    .panel-kicker { margin: 0 0 7px; color: var(--blue-500); font-size: .63rem; font-weight: 850; letter-spacing: .14em; text-transform: uppercase; }
    .panel-title { margin: 0; color: var(--navy-900); font-size: 1.1rem; }
    .panel-copy { margin: 7px 0 0; color: var(--muted); font-size: .76rem; line-height: 1.5; }
    .user-filters { display: grid; grid-template-columns: minmax(240px, 1fr) 190px auto; gap: 10px; padding: 18px 24px; border-bottom: 1px solid var(--line-soft); background: #fbfcfd; }
    .filter-actions { display: flex; gap: 8px; }
    .users-table-wrap { overflow-x: auto; }
    .users-table { width: 100%; border-collapse: collapse; }
    .users-table th { padding: 12px 18px; color: #5d7085; background: #f5f8fa; font-size: .63rem; font-weight: 850; letter-spacing: .07em; text-align: left; text-transform: uppercase; white-space: nowrap; }
    ...
    .empty-users h3 { margin: 0; color: var(--navy-900); }
    ...
    .form-section-title { margin: 0 0 5px; color: var(--navy-900); font-size: .95rem; }
    ...
    .user-side-panel h2 { margin: 0; color: var(--navy-900); font-size: .9rem; }
    ...
    .detail-value { color: var(--navy-900); font-size: .88rem; font-weight: 720; word-break: break-word; }
